...
import ProductBoxSpecial from "./specialProduct";
...
const ProductPage = async ({ params }: { params: any }) => {
  ...
  const specialIds = [164, 161, 91];
  return specialIds.includes(productData.id)
    ? <ProductBox productData={productData} locale={locale} />
    : <ProductBoxSpecial productData={productData} locale={locale} />;
};
