...
const Excellence: React.FC = () => {
  ...
  return (
    <>
      ...
      <section className="min-h-[90vh] excellence py-20 flex flex-row relative mx-auto max-w-[1280px] p-4">
        <div className="w-[97%] ">
        ...
        <div className="flex flex-col items-center gap-[20px]">
          <div className="h-full m-0 p-0 border-solid border-[0px] border-r-[1px] border-t-0 border-b-0 border-l-0 border-[#A5A5A5]"></div>
          <a
            href="#"
