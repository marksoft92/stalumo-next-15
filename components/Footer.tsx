  ...
  return (
    <>
      ...
      <div className="flex items-center algin-center justify-center p-4">
        <span className="flex max-md:flex-col"> <Link href="https://bienkowski.dev/">{t("copy")}</Link>,<Link className="hover:text-[#EB4036]" href={`/${locale?.locale}/privacy-policy`}>{" "+t('PrivacyPolicyTitle')}</Link></span>
      </div>
    </>
  );
}
